                            ...
                            <form action="{{ route('admin.owners.update', ['owner' => $owner->id])}}" method="POST">
                                ...
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 mt-4 w-full flex justify-around">
                                        <button type="button" onclick="location.href='{{ route('admin.owners.index') }}'" class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
